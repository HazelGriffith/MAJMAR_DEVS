...
namespace cadmium::assignment1 {
    class filter_loc_test_model : public Coupled {
        public:
        filter_loc_test_model(const std::string& id): Coupled(id){
            ...
            auto filterLocInput = addComponent<cadmium::lib::IEStream<EvacInfo>>("filterLocInput","../input_data/filter_loc_test_input.txt");
