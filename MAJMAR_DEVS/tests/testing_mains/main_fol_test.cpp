...
#include "../testing_models/fol_test_model.hpp"
...
int main(int argc,char* argv[]){
    ...
    auto model = std::make_shared<fol_test_model>("fol_test_model", testNumber);

    auto rootCoordinator = cadmium::RootCoordinator(model);

    // For simulation purposes, set the name of the output file
	auto logger = std::make_shared<cadmium::CSVLogger>("../simulation_results/fol_test" + testNumber + "_model.csv",",");
