...
#include "../testing_models/coast_guard_ship_test_model.hpp"
...
int main(int argc,char* argv[]){
    ...
    auto model = std::make_shared<coast_guard_ship_test_model>("coast_guard_ship_test_model", testNumber);

    auto rootCoordinator = cadmium::RootCoordinator(model);

    // For simulation purposes, set the name of the output file
	auto logger = std::make_shared<cadmium::CSVLogger>("../simulation_results/coast_guard_ship_test" + testNumber + "_model.csv",",");
