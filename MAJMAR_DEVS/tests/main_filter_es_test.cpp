...
#include "filter_es_test_model.hpp"
...
int main(int argc,char* argv[]){
    ...
    auto model = std::make_shared<filter_es_test_model>("filter_es_test_model");

    auto rootCoordinator = cadmium::RootCoordinator(model);

    // For simulation purposes, set the name of the output file
	auto logger = std::make_shared<cadmium::CSVLogger>("../simulation_results/filter_es_test_model.csv",",");
