...
namespace cadmium::assignment1 {
    class filter_evac_test_model : public Coupled {
        public:
        filter_evac_test_model(const std::string& id): Coupled(id){
            ...
            auto filterEvacInput = addComponent<cadmium::lib::IEStream<EvacInfo>>("filterEvacInput","../input_data/filter_evac_test_input.txt");
