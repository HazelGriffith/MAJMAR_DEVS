...
#include "evacuee_test_model.hpp"
...
int main(int argc,char* argv[]){
    ...
    auto model = std::make_shared<evacuee_test_model>("evacuee_test_model");

    auto rootCoordinator = cadmium::RootCoordinator(model);

    // For simulation purposes, set the name of the output file
	auto logger = std::make_shared<cadmium::CSVLogger>("../simulation_results/evacuee_test_model.csv",",");
