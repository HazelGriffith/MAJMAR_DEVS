...
namespace cadmium::assignment1 {
    class filter_es_test_model : public Coupled {
        public:
        filter_es_test_model(const std::string& id): Coupled(id){
            ...
            auto filterESInput = addComponent<cadmium::lib::IEStream<HeloInfo>>("filterESInput","../input_data/filter_es_test_input.txt");
